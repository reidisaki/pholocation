...
public class InstagramHelper {
    ...
    public void SendImage(String Caption, byte[] ImageByteArray)
            throws UnsupportedEncodingException, ParseException, JSONException, org.json.simple.parser.ParseException {
        ...
        String Data = "{\"device_id\":\"" + DeviceId + "\",\"guid\":\"" + Guid +
                "\",\"username\":\"MYUSERNAME\",\"password\":\"MYPASSWORD\",\"Content-Type\":\"application/x-www-form-urlencoded; charset=UTF-8\"}";
        ...
        if (((String) jsonObject.get("status")).equals("ok")) //Login SuccessFul
        {
            ...
            try {
                final HttpUploadFileHelper http = new HttpUploadFileHelper(new URL("https://instagram.com/api/v1/media/upload/"));
            ...
            if (((String) jsonObject.get("status")).equals("ok")) //Login SuccessFul
            {
                ...
                Data = "{\"device_id\":\"" + DeviceId + "\",\"guid\":\"" + Guid + "\",\"media_id\":\"" + mediaID + "\",\"caption\":\"" + Caption +
                        "\",\"device_timestamp\":\"" + Long.toString((new Date()).getTime()).substring(0, 10) +
